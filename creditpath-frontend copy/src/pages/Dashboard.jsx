...
export default function Dashboard() {
  const stats = [
    { value: '12,483', label: 'Total Borrowers', color: '#00cfff' },
    { value: '23.4%', label: 'Default Rate', color: '#ff4d6d' },
    { value: '₹2.1Cr', label: 'At Risk Portfolio', color: '#ffd700' },
    { value: '67.2%', label: 'Recovery Rate', color: '#00ff88' },
  ]
